...
const language = {
  ...
  german: {
    text: "Die Nutzung vorgefertigter Designs und Funktionen führt im Internet oft zu schlechter Publicity und gleichzeitig zu Geldverlust. Wir bei Web Boutique kreieren und gestalten anders. Jede unserer Softwarelösungen ist auf Sie und Ihre Bedürfnisse zugeschnitten. Sie werden mit Hilfe modernster Entwicklungstechnologie individuell programmiert. Neben Weblösungen entwickeln wir bei Web Botique auch moderne mobile Anwendungen. Wir leben in einer Zeit, in der wir jederzeit und überall über Informationen und andere Dienste verfügen möchten. Wir haben dafür gesorgt, dass unsere gesamte Software an alle Geräte und Formate angepasst ist. Unser Team verwendet die modernste Entwicklungstechnologie, die uns die besten Ergebnisse auf dem Markt ermöglicht. React ist eines unserer am häufigsten verwendeten Programme zum Erstellen komplexer Softwarelösungen. Es wird verwendet, um interaktive Benutzeroberflächen zu erstellen, den Speicherverbrauch zu reduzieren und die Softwareleistung zu erhöhen. Es ist auch sehr wichtig für die Einweg-Datenverbindung, was bedeutet, die Flexibilität und Effizienz der Anwendung zu erhöhen.",
  },
};
