  ...
  return (
    ...
    >
      ...
      <ul className="index">
        ...
        <li>
          <a className="index-link" href="#m1641">
      ...
      E-Mail-Adresse:{" "}
      <p>
        <a href="mailto:webboutiquesolutions@gmail.com">
          webboutiquesolutions@gmail.com
        </a>
      </p>
      ...
      <h2 id="m1641">Vertreter in der Europäischen Union</h2>
      ...
      <p>
        ...
        und genutzten Funktionen gehören. Sofern Nutzer in die Erhebung ihrer
      ...
      <p>
        ...
        kennen nicht die tatsächliche Identität der Nutzer, sondern nur die in
      ...
      <ul className="m-elements">
        <li>
          ...
          Restriktionen für deren Einbindung; <strong>Dienstanbieter:</strong>{" "}
          Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland,
          Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain
          View, CA 94043, USA; <strong>Website:</strong>{" "}
          <a
